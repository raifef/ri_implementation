...
from hdfa_rl_suite.google_pure_v7.config import repository_root, sha256_file
from hdfa_rl_suite.google_pure_v7.controller import require_resolved_controller
from hdfa_rl_suite.google_pure_v7.figure5.seed_registry import validate_registry
...
def snapshot() -> dict[str,Any]:
    ...
    source=list((base/"src/hdfa_rl_suite/google_pure_v6").rglob("*.py"))+list((base/"src/hdfa_rl_suite/google_pure_v7").rglob("*.py"))
