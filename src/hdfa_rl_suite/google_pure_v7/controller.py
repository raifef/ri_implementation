...
from hdfa_rl_suite.google_pure_v6.reference_agent import PureGoogleV6Agent
...
def _controller_code_hash() -> str:
    ...
    paths = [
        root / "src/hdfa_rl_suite/google_pure_v6/policy.py",
        root / "src/hdfa_rl_suite/google_pure_v6/factor_graph.py",
        root / "src/hdfa_rl_suite/google_pure_v6/baseline.py",
        root / "src/hdfa_rl_suite/google_pure_v6/replay.py",
        root / "src/hdfa_rl_suite/google_pure_v6/update.py",
        root / "src/hdfa_rl_suite/google_pure_v6/reference_agent.py",
        Path(__file__),
    ]
