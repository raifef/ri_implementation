...
def run_preflight(config: PreflightConfig = PreflightConfig(), *,
    ...
    checks = [
        ...
        ValidationCheck("sample_budget_current", budget.passed,
                        {"report_hash": budget.report_hash,
                         "selected_budget": budget.metadata.get("selected_validated_budget")},
                        "a validated candidate budget and the published reference satisfy the declared protocol",
    ...
    metadata: Mapping[str, object] = {
        ...
        "selected_validated_budget": budget.metadata.get("selected_validated_budget"),
