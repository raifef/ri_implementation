...
This package is deliberately independent from :mod:`google_rl_certification` and
the staged HDFA controllers.  It reproduces an open algorithm on a declared
surrogate; it does not reproduce Willow hardware.
"""
