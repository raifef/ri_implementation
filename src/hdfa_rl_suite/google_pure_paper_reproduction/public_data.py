...
from hdfa_rl_suite.google_pure_v7.config import canonical_hash, repository_root, sha256_file
...
def reproduce_public_data(*, recompute: bool = False) -> dict[str, Any]:
    ...
    if recompute:
        from hdfa_rl_suite.google_reproduction_v3.analysis import reproduce_public_analysis
        from hdfa_rl_suite.google_reproduction_v3.dataset_manifest import load_json_yaml
