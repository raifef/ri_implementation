...
def assert_merge_compatible(records: Iterable[Mapping[str, Any]]) -> None:
    ...
    keys = ("experiment_family", "protocol_hash", "controller_mode", "controller_hash", "controller_code_hash",
            "parameterization", "expected_controller_mode", "expected_controller_hash",
            "expected_controller_code_hash", "expected_parameterization", "plant_hash", "graph_hash", "mode",
            ...
            "source_budget_profile", "fresh_acquisition")
    for key in keys:
