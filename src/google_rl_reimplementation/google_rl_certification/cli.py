...
def high_shot_main(argv: Sequence[str] | None = None) -> int:
    ...
    _print_cost("google-rl-certify-high-shot", "high_shot_reference", 7768,
...
def compare_budgets_main(argv: Sequence[str] | None = None) -> int:
    ...
    _print_cost("google-rl-compare-budgets", "high_shot_reference", 8050,
                "approximately 20-60 seconds on the bundled runtime")
    _print_cost("google-rl-compare-budgets", "reduced_budget_candidate", 8050,
                "approximately 20-60 seconds on the bundled runtime")
...
def steering_main(argv: Sequence[str] | None = None) -> int:
    ...
    _print_cost("google-rl-steering-sweep", args.configuration, epochs,
