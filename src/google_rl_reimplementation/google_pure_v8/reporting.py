...
def root_cause_report() -> dict[str,Any]:
    ...
    result={"schema_version":"google-pure-v8-root-cause-report.v1","confirmed_implementation_faults":confirmed,
      ...
      "exact_next_commands":["google-rl-v8-run-compact-fault-matrix","google-rl-v8-report-root-cause"] if not gate else ["google-rl-paper-fig5a-acquire --mode reference"],
